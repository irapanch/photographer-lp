...
export const sliderContent = [
  {
    ...
    title: 'Бізнес зйомка',
    description:
      'Ваша візитна картка у світ виробництва та послуг. Від корпоративних портретів до атмосферних знімків робочого процесу - я зроблю ваш бізнес видимим та привабливим для вашої аудиторії.',
  },
  {
    id: 2,
    src: content,
    ...
    title: 'Контентна',
    description:
      'Якісні змінки ваших товарів для соціальних мереж, вебсайтів, для друку тощо. Підходить як блогерам, так і підприємцям чи творчим особистостям для просування бренду або профілю.',
  },
  {
    id: 3,
    src: family,
  ...
  },
  {
    ...
    title: 'Таїнства',
    description:
      'Від хрещення та до вінчання – я зафіксую кожну таїнственну подію з відчуттями та святістю, яку вони несуть.',
  },
  {
    id: 7,
    src: wedding,
